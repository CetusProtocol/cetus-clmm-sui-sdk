...
async function fetchPositionOfOnePool() {
...
async function fetchPositionInfoById() {
  const poolId = '0x83c101a55563b037f4cd25e5b326b26ae6537dc8048004c1408079f7578dd160'
  const positionId = '0xf10d37cc00bcd60f85cef3fe473ea979e3f7f3631d522618e80c876b349e56bc'
  const pool = await TestnetSDK.Pool.getPool(poolId)
  const res = await TestnetSDK.Position.getPosition(pool.position_manager.positions_handle, positionId)
  console.log('fetch position info by id', res)
}
fetchPositionInfoById()
/*
