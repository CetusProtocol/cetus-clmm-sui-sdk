...
describe('Rewarder Module', () => {
  ...
  test('posRewardersAmount', async () => {
    ...
    const res = await sdk.Rewarder.posRewardersAmount(pool.poolAddress,pool.position_manager.positions_handle, "0x5a0a9317df9239a80c5d9623ea87f0ac36f1cec733dc767ba606a6316a078d04")
  ...
  test('collectPoolRewarderTransactionPayload', async () => {
    ...
    const rewards: any[] = await sdk.Rewarder.posRewardersAmount(pool.poolAddress,pool.position_manager.positions_handle, position_object_id)
